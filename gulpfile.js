...
//Tinypng task is the most effecient image compressor but also very time-consuming
...
gulp.task('watch', ['browserSync', 'sass', 'scripts', 'tinypng'], function (){
    gulp.watch('staging/scss/styles.scss', ['sass']);
    gulp.watch('**/*.php', browserSync.reload); 
    gulp.watch('staging/js/*.js', ['scripts']);
    gulp.watch('staging/images/**/*.+(png|jpg|jpeg|gif|svg)', ['tinypng']);
});
